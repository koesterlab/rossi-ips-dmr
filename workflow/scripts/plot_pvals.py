...
column_names = ['chr', 'start', 'stop', 'q-value', 'mean_methylation_difference',
                'num_CpGs', 'p_MWU', 'p_2D_KS', 'mean_g1', 'mean_g2']
...
combined_histograms = alt.vconcat(
    hist_mwu,
    hist_ks
).resolve_scale(
    y='independent'
